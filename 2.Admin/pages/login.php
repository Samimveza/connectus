...
<div class="login-container" ng-controller="loginController" ng-init="controller.setInfo()">
    <div class="login-card">
        ...
        <form id="loginForm" name="loginForm">
            ...
            <div class="login-form" ng-show="controller.step == 1">
                ...
                <button type="submit" class="btn-submit" ng-click="controller.login()">Submit</button>
