    ...
    <div class="profile-card">
        <div class="profile-image-container">
            <div class="profile-image-placeholder">
                <img src="/images/sample-company-logo.png" alt="Company Logo" ng-show="!controller.cardDetail.companyLogo.url">
                <img src="{{controller.cardDetail.companyLogo.url}}" alt="Company Logo" ng-show="controller.cardDetail.companyLogo.url">
            </div>
        ...
        <div class="profile-info">
            <div class="profile-name-container">
                <h2 class="profile-name">{{controller.cardDetail.companyName || 'Company Name'}}</h2>
                <p class="profile-title">{{controller.cardDetail.businessType || 'Business Type'}}</p>
                <p class="profile-company">{{controller.cardDetail.industry || 'Industry'}}</p>
            </div>
            <div class="profile-contact">
                <div class="contact-item">
                    <i class="fas fa-envelope"></i>
                    <span>{{controller.cardDetail.email || 'info@company.com'}}</span>
                </div>
