class shopProductListController {
    scope;
    baseController: baseController;
    shopWebService: shopWebService;
    ...
    public toggleProductSelection(product) {
        var self = this;
    ...
    public selectAllProducts() {
        var self = this;
        var allSelected = self.list.every(product => product.isSelected);
        ...
        if (!allSelected) {
            self.selectedProducts = [...self.list];
        } else {
            self.selectedProducts = [];
        }
    }
    ...
    public toggleProductStatus(product) {
        var self = this;
...
shopModule.controller("shopProductListController"
    , ["$scope"
        , "shopWebService"
