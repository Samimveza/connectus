<div class="information-form" ng-controller="cardDetailPortfolioController">
    ...
    <div class="form-section">
        <h2 class="section-title">Product/Services</h2>
        ...
        <!--<div class="management-option">
            <div class="option-header">
                <label>Make product/service private</label>
            ...
            <p class="option-description">When enabled, your product/service will be protected by a password. Only those with the password will be able to view it.</p>
        </div>

        <div class="form-group" ng-if="controller.cardDetail.portfolioPasswordIsEnabled">
            <label for="portfolioPassword">Password</label>
            <input type="password" id="portfolioPassword" class="form-input" ng-model="controller.cardDetail.portfolioPassword" placeholder="Password" name="portfolioPassword">
        </div>-->

        <h2 class="section-title">Product/Service Items</h2>
        ...
        <div class="no-fields-message" ng-if="!controller.cardDetail.portfolios || controller.cardDetail.portfolios.length === 0">
            ...
            <h3>No Product/Service Items Added Yet</h3>
            <p>Add product/service items to showcase your personal work, products, or services</p>
        </div>
        ...
        <div class="field-item gallery-item"
            ...
            <div class="field-item-header">
                ...
                <span class="field-type">
                    ...
                    Product/Service Item - {{portfolioItem.name || 'Untitled'}}
                </span>
            ...
            <div class="field-content">
                ...
                <div class="form-group">
                    ...
                    <textarea ng-model="portfolioItem.description" placeholder="Brief description of this product/service item" class="form-input" rows="3"></textarea>
                </div>
        ...
        <button class="btn-submit" type="button" ng-click="controller.addPortfolio()">
            <i class="fas fa-plus"></i> Add Product/Service Item
        </button>
    </div>
