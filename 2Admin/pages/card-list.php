<!-- Cards Page Content -->
<div class="cards-page" ng-controller="cardListController" ng-init="controller.setInfo(controller.structureTypeEnum.INDIVIDUAL)">
    ...
    <!-- Load More Button -->
    <div class="load-more-container" ng-if="controller.paging.pageCount > (controller.list.length / controller.paging.pageSize)">
    ...
    <div class="profile-card-container add-card-container d-md-block" ng-click="controller.newCard()">
        <div class="add-card">
            <div class="add-card-content">
                ...
                <h3 class="add-card-text">Create New Profile</h3>
                <p class="add-card-desc">Add a personal profile to your collection</p>
            </div>
        </div>
    </div>
